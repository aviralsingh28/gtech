...
<h2 className="text-4xl sm:text-5xl font-bold text-[#f5a623] mb-4">
  Development Roadmap
        ...
        <div className="relative pt-8">
          {/* SVG Path for the vertical road */}
          <svg
            className="absolute left-1/2 transform -translate-x-1/2 top-0 w-1 h-full pointer-events-none"
            viewBox="0 0 2 2000"
          ...
          >
            ...
            {/* Vertical line */}
            <line x1="1" y1="0" x2="1" y2="2000" stroke="url(#verticalRoadGradient)" strokeWidth="8" opacity="0.3" />
            
            {/* White dashed line */}
            <line x1="1" y1="0" x2="1" y2="2000" stroke="black" strokeWidth="2" strokeDasharray="30,25" opacity="0.8" />
          </svg>

          {/* Roadmap Items */}
          <div className="relative space-y-32 py-16 px-8 sm:px-12 lg:px-20 xl:px-28">
...
const RoadmapCard: React.FC<{
  ...
  <div
  className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 px-10 py-14 lg:px-12 lg:py-16 h-full flex flex-col my-8"
  >
    {/* Icon */}
    ...
    {/* Description */}
    <p className="text-center text-gray-600 text-lg leading-9 mb-10 px-4">
      {item.description}
    </p>
  ...
  <div className="mt-8 flex justify-center">
    <ul className="space-y-5  w-full max-w-md">
      {item.features.map((feature, idx) => (
        ...
        >
          <span className="w-3 h-3 rounded-full bg-gradient-to-r from-blue-500 to-orange-500 shrink-0"></span>
